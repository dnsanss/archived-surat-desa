...
<div class="max-w-6xl mx-auto mt-24 px-4">
    <h2 class="text-center text-2xl font-bold mb-8  pb-2 text-green-700">
        BERITA TERBARU
    </h2>
    ...
    @else
    {{-- ==== BERITA UTAMA ==== --}}
    @php $item = $berita->first(); @endphp
    <div class="bg-white shadow-lg rounded-xl p-5 flex flex-col md:flex-row items-center gap-5 mb-10">
        {{-- Gambar --}}
        @if ($item->gambar_url)
